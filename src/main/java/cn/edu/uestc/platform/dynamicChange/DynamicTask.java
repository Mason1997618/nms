...
public class DynamicTask implements Runnable {
	...
	public DynamicTask(TextArea text) {
		this.text =  text;
	}
...
//		//GEO TO LEO
		...
		for (NewLink link : changeLinks(linksBefore, links)) {
			DynamicFactory.delPort(os, IPCreateFactory.searchData(link, IPCreateFactory.createTableLR())[0], IPCreateFactory.searchData(link, IPCreateFactory.createTableLR())[2]);
			DynamicFactory.delPort(os, IPCreateFactory.searchData(link, IPCreateFactory.createTableLR())[1], IPCreateFactory.searchData(link, IPCreateFactory.createTableLR())[3]);
		}
		
		// LeoToLeo增加
		for (NewLink link : changeLinks(links,linksBefore)) {
			DynamicFactory.addPort(os, IPCreateFactory.searchData(link, IPCreateFactory.createTableLR())[0], IPCreateFactory.searchData(link, IPCreateFactory.createTableLR())[2]);
			DynamicFactory.addPort(os, IPCreateFactory.searchData(link, IPCreateFactory.createTableLR())[1], IPCreateFactory.searchData(link, IPCreateFactory.createTableLR())[3]);
		}
		...
		for (NewLink link : changeLinks( lgLinksBefore,lgLinks)) {
			...
			DynamicFactory.delPort(os, IPCreateFactory.searchData(link, IPCreateFactory.createTableGEOToMEO())[1], IPCreateFactory.searchData(link, IPCreateFactory.createTableGEOToMEO())[3]);
		}
		...
		for (NewLink link : changeLinks(lgLinks, lgLinksBefore)) {
			...
			DynamicFactory.addPort(os, IPCreateFactory.searchData(link, IPCreateFactory.createTableGEOToMEO())[1], IPCreateFactory.searchData(link, IPCreateFactory.createTableGEOToMEO())[3]);
		}
	}
